...
const __TWEAKS_STYLE = `
  ...
  .twk-hd b{font-size:12px;letter-spacing:.01em}
  ...
  .twk-sect{font-size:10px;letter-spacing:.06em;text-transform:uppercase;
  ...
  .twk-seg button{appearance:none;position:relative;z-index:1;flex:1;border:0;
    background:transparent;color:inherit;font:inherit;min-height:22px;
  ...
  .twk-num-lbl{color:rgba(41,38,27,.6);cursor:ew-resize;
  ...
  .twk-btn{appearance:none;height:26px;padding:0 12px;border:0;border-radius:7px;
    background:rgba(0,0,0,.78);color:#fff;font:inherit;cursor:default}
